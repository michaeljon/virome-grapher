...
const themeOptions: ThemeOptions = {
  ...
  components: {
    MuiAppBar: {
      styleOverrides: {
        root: {
          // backgroundColor: darken(themeColors.primaryAlt, 0.4),
...
export const darkTheme = createTheme({ ...themeOptions, palette: { ...themeOptions.palette, mode: 'dark' } });
export const lightTheme = createTheme({ ...themeOptions, palette: { ...themeOptions.palette, mode: 'light' } });
